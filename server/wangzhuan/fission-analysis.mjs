...
export const FISSION_ANALYSIS_PROMPT_REQUIREMENTS = Object.freeze([
  ...
  "seedanceSlices are optional: if you can output high-quality executable generation slices, keep them in source-video order and include numeric startSec, endSec, durationSec, and sliceDurationSec; otherwise omit them and backend will derive generation slices from storySegments plus sliceSplitHints. Keep every generated slice between 5 and 15 seconds, splitting longer story beats by narrative turning points.",
